    ...
    <>
      ...
      <section className='max-w-4xl mx-auto p-4 flex flex-col gap-4'>
        ...
        <div className='flex flex-col gap-6 sm:text-lg'>
          <h3 className='text-2xl'>June 6th - 9th, 2024</h3>
          <p>
            Registration is currently being handled through this <a className='text-green-700 hover:text-green-500 font-bold' href='https://docs.google.com/forms/d/1S1I07h8fHsKD-x72QtBx9kVoF4yhsG54z7vzOkpuanw/viewform' alt='Google form for event' target="_blank" rel="noreferrer">google form</a>.
          </p>
          <p>
