...
export default function Intro() {
  return (
    <>
      <p className='my-2'>
        Welcome to the Chief Ladiga Silver Comet 188 mile Sk8 Challenge! This is a 3 day event of distance skateboarding through the Taladega National rainforest. The ride spans 2 states, 2 timezones, 5 counties and about 188 miles.
      </p>
      <p className='my-2'>
      ...
      <p className='my-2'>
        We've had riders as young as 12 and as old aWs 56 participate in this event. If you're interested in joining in one of the most unique rides you can do on a skateboard, then you've come to the right place. This is potentially something fun for all ages.
      </p>
    </>
  )
}